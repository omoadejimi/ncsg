...
Nigerian names come from hundreds of naming traditions. Never validate names against an English-centric pattern. Allow long names, short names, hyphens, diacritics, apostrophes and single names.
